...
const model = {
  ...
  generateAuthorizationCode: require('./generateAuthorizationCode'),
  getAccessToken: require('./getAccessToken'),
  getAuthorizationCode: require('./getAuthorizationCode'),
  getClient: require('./getClient'),
  revokeAuthorizationCode: require('./revokeAuthorizationCode'),
  saveAuthorizationCode: require('./saveAuthorizationCode'),
...
module.exports = new ExpressOAuthServer({
  ...
  accessTokenLifetime: 60 * 60, // 24 hours, or 1 day
